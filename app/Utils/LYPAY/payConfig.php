...
class PayConfig
{
    ...
    function InsertPayLog($request_data, $BillNO, $Gold, $UserName = "", $Check = 1, $Platform = 'RCPAY', $Music = 1)
    {
        ...
        if ($cou == 0) {
            ...
            $sql_amt = "UPDATE web_member_data SET Credit = Credit + ?, Money = Money + ?, withdrawal_condition = withdrawal_condition + ? WHERE UserName = ?";
            $q1 = DB::update($sql_amt, [$Gold, $Gold, $Gold, $UserName]);
            // return $q1;
            if ($q1 > 0) {
