...
class BettingController extends Controller
{
    public function saveFTBettingOrderData (Request $request) {
        ...
        try {
            ...
            $rerate = $request_data["rerate"];
            $qteam = $request_data["qteam"];
            $gold = $request_data["gold"];
            $active = $request_data["active"];
            $line_type = $request_data["line_type"];
            $gid = $request_data["gid"];
            $type = $request_data["type"];
            $gnum = $request_data["gnum"];
            $ioradio_r_h = $request_data["ioradio_r_h"];
            ...
            $bet_score = WebReportData::where('M_Name', $user_name)->where('Cancel', 0)->where('MID', $request_data['gid'])->sum('BetScore');
            ...
            $match_sports = Sport::where('MID', $gid)->whereRaw("Cancel != 1 and Open = 1 and MB_Team != '' and MB_Team_tw != '' and MB_Team_en != '' and M_Start > now()")->first();
