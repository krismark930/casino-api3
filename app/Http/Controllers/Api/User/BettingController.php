            ...
            for ($i=0; $i < $bet_count; $i++) {
                ...
                if (in_array($mtype[$i], $handicap_array)) {
                    ...
                    if ($show_type_array[$i] == "H") {
                        ...
                        $lines=$lines.$league_array[$i]."(".date("m-d").")"."<br>".$m_team_array[$i]."&nbsp;&nbsp;<FONT COLOR=#0000BB><b>".$Sign."</b></FONT>&nbsp;&nbsp;".$t_team_array[$i]."&nbsp;&nbsp;<FONT color=red><b>$inball</b></FONT><br>";

                    } else {

                        $inball = $t_ball_array[$i] . ":" . $m_ball_array[$i];

                        $lines=$lines.$league_array[$i]."(".date("m-d").")"."<br>".$t_team_array[$i]."&nbsp;&nbsp;<FONT COLOR=#0000BB><b>".$Sign."</b></FONT>&nbsp;&nbsp;".$m_team_array[$i]."&nbsp;&nbsp;<FONT color=red><b>$inball</b></FONT><br>";
