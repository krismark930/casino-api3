...
class BKBettingController extends Controller
{
    ...
    public function saveBKBettingInPlay(Request $request)
    {
        ...
        try {
            ...
            $lines_tw=$match_sports['M_League_tw']."(".date("m-d").")"."<br>[".$match_sports['MB_MID'].']vs['.$match_sports['TG_MID']."]<br>".$w_mb_team_tw."&nbsp;&nbsp;<FONT COLOR=#0000BB><b>".$Sign."</b></FONT>&nbsp;&nbsp;".$w_tg_team_tw."&nbsp;&nbsp;<FONT color=red><b>$inball</b></FONT><br>";

            $lines_tw=$lines_tw."<FONT color=#cc0000>$w_m_place_tw</FONT>&nbsp;@&nbsp;<FONT color=#cc0000><b>".$w_m_rate."</b></FONT>";



            $lines_en=$match_sports['M_League_en']."(".date("m-d").")"."<br>[".$match_sports['MB_MID'].']vs['.$match_sports['TG_MID']."]<br>".$w_mb_team_en."&nbsp;&nbsp;<FONT COLOR=#0000BB><b>".$Sign."</b></FONT>&nbsp;&nbsp;".$w_tg_team_en."&nbsp;&nbsp;<FONT color=red><b>$inball</b></FONT><br>";
