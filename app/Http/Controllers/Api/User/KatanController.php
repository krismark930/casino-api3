...
class KatanController extends Controller
{
    ...
    public function saveNewMacaoKatan(Request $request)
    {
            ...
            for ($r = 0; $r < $numm; $r++) {
                ...
                if (in_array((string)$r, $class3_array)) {
                    ...
                    if ($ka_bl["class1"] == "特码" && $r <= 49) {
                        ...
                        $sum_m55 = NewMacaoKatan::where("Kithe", $Current_Kithe_Num)
                            ->where("class1", $ka_bl["class1"])
                            ->where("class2", $ka_bl["class2"])
                            ->where("class3", $ka_bl["class3"])
                            ->sum("sum_m");
                    ...
                    $sum_m = NewMacaoKatan::where("Kithe", $Current_Kithe_Num)
                        ->where("class1", $ka_bl["class1"])
                        ->where("class2", $ka_bl["class2"])
                        ->where("class3", $ka_bl["class3"])
                        ->where("username", $user["UserName"])
    ...
    public function saveNewMacaoKatanParlay(Request $request)
    {
    ...
    public function saveNewMacaoKatanEven(Request $request)
    {
        ...
        try {
            ...
            foreach ($data as $item) {
                ...
                if ($user->save()) {
                    ...
                    NewMacaoKatan::where("id", $ouid)->delete();
                    $response['message'] = 'If the bet is unsuccessful, please contact the customer service!';
                    return response()->json($response, $response['status']);
                }
            }
    ...
    public function saveNewMacaoKatanCompatible(Request $request)
    {
    ...
    public function saveNewMacaoKatanZodiacEven(Request $request)
    {
    ...
    public function saveNewMacaoKatanMantissaEven(Request $request)
    {
    ...
    public function saveNewMacaoKatanMissAll(Request $request)
    {
    ...
    public function getNewMacaoMainBetResult(Request $request) {
        ...
        try {
            ...
            $ka_kithe = NewMacaoKakithe::orderBy('nn', 'desc')->get(['nn', 'nd']);

            $user = $request->user();

            foreach($ka_kithe as $item) {

                $result = NewMacaoKatan::where("kithe", $item["nn"])->where("username", $user["UserName"])->first();

                if (isset($result)) {

                    $result1 = NewMacaoKatan::select(DB::raw('sum(sum_m) as sum_m,count(*) as re,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc'));

                    $result1 = $result1->where("kithe", $item["nn"])->where("username", $user["UserName"]);
                    
                    $result2 = NewMacaoKatan::select(DB::raw('sum(sum_m*dai_zc/10-sum_m*rate*dai_zc/10+sum_m*(dai_ds-user_ds)/100*(10-dai_zc)/10-sum_m*user_ds/100*(dai_zc)/10) as daisf,sum(sum_m*zong_zc/10-sum_m*rate*zong_zc/10+sum_m*(zong_ds-dai_ds)/100*(10-zong_zc-dai_zc)/10-sum_m*dai_ds/100*(zong_zc)/10) as zongsf,sum(sum_m*guan_zc/10-sum_m*rate*guan_zc/10+sum_m*(guan_ds-zong_ds)/100*(10-guan_zc-zong_zc-dai_zc)/10-sum_m*zong_ds/100*(guan_zc)/10) as guansf,sum(sum_m*rate-sum_m+sum_m*Abs(user_ds)/100) as sum_m,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc,sum(sum_m*Abs(user_ds)/100) as user_ds,sum(sum_m*Abs(guan_ds-zong_ds)/100*(10-guan_zc-zong_zc-dai_zc)/10) as guan_ds,sum(sum_m*Abs(zong_ds-dai_ds)/100*(10-zong_zc-dai_zc)/10) as zong_ds,sum(sum_m*Abs(dai_ds-user_ds)/100*(10-dai_zc)/10) as dai_ds'));

                    $result2 = $result2->where("kithe", $item["nn"])->where("username", $user["UserName"])->where("bm", 1);
                    
                    $result3 = NewMacaoKatan::select(DB::raw('sum(sum_m*Abs(dai_ds-user_ds)/100*(10-dai_zc)/10+sum_m*dai_zc/10-sum_m*(dai_zc)/10*user_ds/100) as daisf,sum(sum_m*Abs(zong_ds-dai_ds)/100*(10-zong_zc-dai_zc)/10+sum_m*zong_zc/10-sum_m*(zong_zc)/10*dai_ds/100) as zongsf,sum(sum_m*Abs(guan_ds-zong_ds)/100*(10-guan_zc-zong_zc-dai_zc)/10+sum_m*guan_zc/10-sum_m*guan_zc/10*zong_ds/100) as guansf,sum(sum_m*Abs(user_ds)/100-sum_m) as sum_m,sum(sum_m*dagu_zc/10) as dagu_zc,sum(sum_m*guan_zc/10) as guan_zc,sum(sum_m*zong_zc/10) as zong_zc,sum(sum_m*dai_zc/10) as dai_zc,sum(sum_m*Abs(user_ds)/100) as user_ds,sum(sum_m*Abs(guan_ds-zong_ds)/100*(10-guan_zc-zong_zc-dai_zc)/10) as guan_ds,sum(sum_m*Abs(zong_ds-dai_ds)/100*(10-zong_zc-dai_zc)/10) as zong_ds,sum(sum_m*Abs(dai_ds-user_ds)/100*(10-dai_zc)/10) as dai_ds'));
    ...
    public function getNewMacaoSubBetResult(Request $request) {
        ...
        try {
            ...
            $ka_tan = NewMacaoKatan::where("kithe", $period)->where("username", $user["UserName"])->get();
