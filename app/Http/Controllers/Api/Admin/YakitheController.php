...
class YakitheController extends Controller
{
    ...
    public function getNewMacaoYakitheItemById(Request $request) {
        ...
        try {
            ...
            $ya_kithe = NewMacaoYakithe::find($id);

            $response['data'] = $ya_kithe;
            $response['message'] = "New MacaoYakithe Data fetched successfully!";
            $response['success'] = TRUE;
            $response['status'] = STATUS_OK;
        } catch (Exception $e) {
            $response['message'] = $e->getMessage() . ' Line No ' . $e->getLine() . ' in File' . $e->getFile();
    ...
    public function getNewMacaoYakitheAll(Request $request) {
    ...
    public function updateNewMacaoYakithe(Request $request) {
        ...
        try {
            ...
            if ($ya_kithe->save()) {
                $response["data"] = $ya_kithe;
                $response['message'] = "New MacaoYakithe data updated successfully!";
                $response['success'] = TRUE;
                $response['status'] = STATUS_OK;
            }
        } catch (Exception $e) {
