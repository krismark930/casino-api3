...
class AdminLotteryResultAZXY10Controller extends Controller
{
    public function getLotteryResult(Request $request) {
        ...
        try {   
            ...
            $lottery_type = "澳洲幸运10";
            $result = LotteryResultAZXY10::whereDate("datetime", "=", $query_time);
            if ($qishu_query != "") {
            ...
            $response['message'] = "Lottery Result AZXY10 Data fetched successfully!";
    ...
    public function getLotteryResultById(Request $request) {
        ...
        try {   
            ...
            $id = $request_data["id"];
            $result = LotteryResultAZXY10::find($id);
    ...
    public function saveLotteryResult(Request $request) {
        ...
        try {   
            ...
            if ($action == "add" && $id==0) {
                ...
                $result = LotteryResultAZXY10::where("qishu", $qishu)->first();
                ...
                $item = LotteryResultAZXY10::find($id);
            ...
            $response['message'] = "AZXY10 Lottery Result updated successfully!";
            $response['success'] = TRUE;
            $response['status'] = STATUS_OK;
        } catch (Exception $e) {
            $response['message'] = $e->getMessage() . ' Line No ' . $e->getLine() . ' in File' . $e->getFile();
    ...
    public function checkoutResult(Request $request) {
        ...
        try {   
            ...
            $g_type = $request_data["g_type"] ?? "AZXY10";
            $qishu = $request_data["qishu"];
