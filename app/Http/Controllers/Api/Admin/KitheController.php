    ...
    public function winKakithe(Request $request) {
        ...
        try {
            ...
            for ($i=1;$i<=6;$i++){
                ...
                if ($i==1){$class2="正码1";$tmtm=$n1;}
                if ($i==2){$class2="正码2";$tmtm=$n2;}
                if ($i==3){$class2="正码3";$tmtm=$n3;}
                if ($i==4){$class2="正码4";$tmtm=$n4;}
                if ($i==5){$class2="正码5";$tmtm=$n5;}
                if ($i==6){$class2="正码6";$tmtm=$n6;}
            ...
            $lvbo_z = 0;
            $lanbo_z = 0;
            if($wsws0=="红波") $hongbo_na = $hongbo_na + 1.5; 
            if($wsws0=="绿波") $lvbo_na = $lvbo_na + 1.5;
            if($wsws0=="蓝波") $lanbo_na = $lanbo_na + 1.5;

            if ($wsws1 == "红波") $hongbo = $hongbo + 1;
            if ($wsws1 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws1 == "蓝波") $lanbo = $lanbo + 1;
            if ($wsws2 == "红波") $hongbo = $hongbo + 1;
            if ($wsws2 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws2 == "蓝波") $lanbo = $lanbo + 1;
            if ($wsws3 == "红波") $hongbo = $hongbo + 1;
            if ($wsws3 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws3 == "蓝波") $lanbo = $lanbo + 1;
            if ($wsws4 == "红波") $hongbo = $hongbo + 1;
            if ($wsws4 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws4 == "蓝波") $lanbo = $lanbo + 1;
            if ($wsws5 == "红波") $hongbo = $hongbo + 1;
            if ($wsws5 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws5 == "蓝波") $lanbo = $lanbo + 1;
            if ($wsws6 == "红波") $hongbo = $hongbo + 1;
            if ($wsws6 == "绿波") $lvbo = $lvbo + 1;
            if ($wsws6 == "蓝波") $lanbo = $lanbo + 1;
