...
class AdminLotteryResultGDSFController extends Controller
{
    public function getLotteryResult(Request $request)
    {
        ...
        try {
            ...
            $lottery_type = "广东十分彩";
            $result = LotteryResultGDSF::whereDate("datetime", "=", $query_time);
            if ($qishu_query != "") {
            ...
            $response['message'] = "Lottery Result GDSF Data fetched successfully!";
    ...
    public function getLotteryResultById(Request $request)
    {
        ...
        try {
            ...
            $id = $request_data["id"];
            $result = LotteryResultGDSF::find($id);
    ...
    public function saveLotteryResult(Request $request)
    {
        ...
        try {
            ...
            if ($action == "add" && $id == 0) {
                ...
                $result = LotteryResultGDSF::where("qishu", $qishu)->first();
                ...
                $item = LotteryResultGDSF::find($id);
            ...
            $response['message'] = "GDSF Lottery Result updated successfully!";
            $response['success'] = TRUE;
            $response['status'] = STATUS_OK;
        } catch (Exception $e) {
            $response['message'] = $e->getMessage() . ' Line No ' . $e->getLine() . ' in File' . $e->getFile();
    ...
    public function checkoutResult(Request $request)
    {
        ...
        try {
            ...
            $g_type = $request_data["g_type"] ?? "GDSF";
            $qishu = $request_data["qishu"];
